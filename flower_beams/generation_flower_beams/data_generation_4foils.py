...
for Rytov in Rytovs:
    ...
    for foil in foils:
        ...
        for indx in trange(SAMPLES, desc="Propagation Progress"):
            ...
            if save:
                np.save(f'foil4_field_XY_{Rytov}_{foil_str}.npy', field_z_crop)
            ...
            if spectrum_save:
                ...
                plt.show()
                if save:
                    np.save(f'foil4_spectr_XY__{Rytov}_{foil_str}.npy', spectrum)
            ...
            if save:
                np.save(f'foil4_dots_{Rytov}_{foil_str}.npy', dots_cut)
            if plot_3d:
