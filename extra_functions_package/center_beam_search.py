...
def LG_spectre_coeff(field, l, p, xM=(-1, 1), yM=(-1, 1), width=1.0, k0=1.0, mesh=None, functions=bp.LG_simple):
	"""
	Calculate a single coefficient of LG_l_p in the LG spectrum of the given field.

	Parameters:
	field (ndarray): Complex electric field.
	l (int): Azimuthal index of LG beam.
	p (int): Radial index of LG beam.
	...
	k0 (float): Parameter k0 in LG beam (only relevant for z=0). Default is 1.0.
	...
	Returns:
	complex: Complex weight of LG_l_p in the spectrum.
	"""
	if mesh is None:
	...
	# Compute the coefficient using the overlap integral
