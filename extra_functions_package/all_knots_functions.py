...
# 	"""
# 	Remove a specific lobe of the mesh.
#
# 	Parameters:
# 	-----------
...
# 		The 3D mesh grids (x, y, z).
# 	angle1 : float
# 		Start angle in radians for phase removal.
# 	angle2 : float
# 		End angle in radians for phase removal.
# 	rot_x, rot_y, rot_z : float
# 		Rotation angles in degrees along the x, y, z axes.
#
# 	Returns:
# 	--------
# 	mesh2 : tuple of ndarrays
# 		Modified mesh with the specified lobe removed.
# 	"""
# 	phase = np.angle(mesh[0] + 1j * mesh[1])
# 	phase_mask = (phase > angle1) & (phase <= angle2)
#
# 	# Apply rotation to the selected lobe and rescale
...
# 	)
#
# 	# Update the mesh with the modified values
# 	mesh2 = np.copy(mesh)
...
# 	"""
# 	Reduce the size of a specific lobe of the mesh.
#
# 	Parameters:
# 	-----------
# 	mesh : tuple of ndarrays
# 		The 3D mesh grids (x, y, z).
# 	angle1 : float
# 		Start angle in radians for phase modification.
# 	angle2 : float
# 		End angle in radians for phase modification.
# 	rot_x, rot_y, rot_z : float
# 		Rotation angles in degrees along the x, y, z axes.
#
# 	Returns:
# 	--------
# 	mesh2 : tuple of ndarrays
# 		Modified mesh with the specified lobe scaled down.
# 	"""
# 	phase = np.angle(mesh[0] + 1j * mesh[1])
# 	phase_mask = (phase > angle1) & (phase <= angle2)
#
